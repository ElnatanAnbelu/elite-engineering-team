...
```bash
find ~/.claude/skills -name SKILL.md | wc -l   # expect 33 (30 specialists + staff-engineer)
```
...
- **$39 one-time** — mandatory. This buys the complete org: 30 specialist skills + the Staff Engineer
